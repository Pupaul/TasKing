...
import "../../App.css";
import image1 from "../../assets/TK1.png";
import image2 from "../../assets/TK2.png";
import image3 from "../../assets/TK3.png";
import image4 from "../../assets/TK4.png";
      ...
      <div className="container-motto">
        <div className="motto-text mt-10">
          <h1 className="text-4xl font-bold">
            "Unlock Your Potential, Execute with TasKing."
          </h1>
        </div>
        <Link to="/dashboard">
        <button
